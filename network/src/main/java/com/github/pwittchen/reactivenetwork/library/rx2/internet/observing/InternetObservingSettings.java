...
public final class InternetObservingSettings {
    ...
    private InternetObservingSettings(int initialInterval, int interval, String host, int port, int timeout, int httpResponse, ErrorHandler errorHandler, InternetObservingStrategy strategy) {
